...
```{sql SQL Query, eval=FALSE, include=FALSE}
...
```{r Import data and Libraries, include=FALSE}
...
confusionMatrix(test$over_50k, factor(test$classification))
